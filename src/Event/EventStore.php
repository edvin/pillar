...
interface EventStore
{
    ...
    /**
     * Loads the events for the given aggregate root, optionally after a specific per-aggregate sequence number.
     *
     ...
     *
     * @param AggregateRootId $id The identifier of the aggregate root.
     * @param int $afterAggregateSequence The per-aggregate sequence number after which to load events (default is 0).
