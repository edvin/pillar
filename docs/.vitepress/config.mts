        ...
        sidebar: [
            ...
            { text: 'Tutorial', items: [{ text: 'Build a Document service', link: '/tutorials/build-a-document-service' }] },
            {
                text: 'Concepts', items: [
                    ...
                    { text: 'Serialization', link: '/concepts/serialization' },            // NEW
                    { text: 'Commands & Queries', link: '/concepts/commands-and-queries' } // NEW
                ]
            },
            {
                text: 'Guides', items: [                                                // NEW GROUP
